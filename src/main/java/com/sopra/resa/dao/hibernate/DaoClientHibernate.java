...
public class DaoClientHibernate extends DaoGenericImpl<Clientspring,Long> implements DaoClient {
...
//			 .getResultList();
	 ...
	 return em.createNamedQuery("Client.findByName",Clientspring.class)
			 .setParameter("pnom", nom)
			 .getResultList();
    }
